  ...
  return (
    <Router>
      <Routes>
        ...
        {/* 🌐 TIER 1: PUBLIC FRONT-DOOR (No Cart, Just Simple Login/Signup Header) */}
        ...
        {/* 🛒 TIER 2: PHARMACY STOREFRONT (Has the special Shopping Cart Header) */}
        ...
        {/* 🏥 TIER 3: SECURE MEDICAL PORTAL (Uses the clean Navbar we just fixed) */}
